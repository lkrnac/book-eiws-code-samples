...
@SpringApplicationConfiguration(classes = { JmsDestinationResolverApplication.class,
    TestSimpleMessageConfiguration.class })
public class JmsDestinationResolverApplicationTests extends CommonJmsSimpleMessageTest {
}
